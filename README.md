...
Lattice is a simulation framework focused on discrete spatial worlds, constrained fills, chunk loading, and extensible rule systems.

---

## Current Status

- Phase 1 (Stable 2D Core) is complete: grid, fills, chunks, tests, and a matplotlib viewer.
- The next step is Phase 2: clean architecture and modularization.
